! function(t) {
    ...
    function c(t, e) {
        var i = new Image;
        return i.src = t, i.onload = e, i.crossOrigin = "Anonymous", i
    }
        ...
        GyroNorm: function() {
            ...
            return E.GAME = a, E.WORLD = n, E.DEVICE_ORIENTATION = o, E.ACCELERATION = r, E.ACCELERATION_INCLUDING_GRAVITY = s, E.ROTATION_RATE = l, E.prototype.init = function(t) {
                ...
                switch (t) {
                    ...
                    default:
                        return {
                            deviceOrientationAvailable: e.alpha && null !== e.alpha && e.beta && null !== e.beta && e.gamma && null !== e.gamma, accelerationAvailable: i && i.x && i.y && i.z, accelerationIncludingGravityAvailable: a && a.x && a.y && a.z, rotationRateAvailable: n && n.alpha && n.beta && n.gamma
                        }
                }
